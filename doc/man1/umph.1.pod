...
umph [-q] [-i] [--export-format=E<lt>valueE<gt>] [--type=E<lt>valueE<gt>]
     [[--all | [--start-index=E<lt>valueE<gt>] [--max-results=E<lt>valueE<gt>]]
     [--proxy=E<lt>addrE<gt> | --no-proxy] [--help]
...
Use the C<--interactive> switch to open the prompt. Note that umph
uses (as of 0.2.0) the Umph::Prompt module for this. Once the prompt
